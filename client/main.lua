	...
	if used < silencieux then
		if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
			...
			ESX.ShowNotification((
				"Du hast deine Waffe mit einem Schalldämpfer ausgestattet. Er muss nach jedem Powernap neu ausgerütstet werden."))
			used = used + 1
		...
		elseif currentWeaponHash == GetHashKey("WEAPON_SNIPERRIFLE") then
			...
			ESX.ShowNotification((
				"Du hast keine Waffe in der Hand oder deine Waffe kann nicht mit einem Schalldämpfer ausgerüstet werden!."))
		end
	else
		ESX.ShowNotification(("Du hast alle Schalldämpfer verbraucht."))
	end
end)
local used2 = 0
...
AddEventHandler('eden_accesories:flashlight', function(duration)
	...
	if used2 < flashlight then
		if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
			...
			ESX.ShowNotification((
				"Du hast deine Waffe mit einer Lampfe ausgestattet. Sie muss nach jedem Powernap neu ausgerütstet werden."))
			used2 = used2 + 1
		...
		elseif currentWeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE") then
			...
			ESX.ShowNotification(("Du hast keine Waffe in der Hand oder deine Waffe kann keine Lampe halten."))
		end
	else
		ESX.ShowNotification(("Du hast alle Lampen verbraucht."))
	end
end)
...
AddEventHandler('eden_accesories:grip', function(duration)
	...
	if used3 < grip then
		if currentWeaponHash == GetHashKey("WEAPON_COMBATPDW") then
			...
			ESX.ShowNotification((
				"Du hast deine Waffe mit einem Griff ausgestattet. Er muss nach jedem Powernap neu ausgerütstet werden."
				))
			used3 = used3 + 1
		...
		elseif currentWeaponHash == GetHashKey("WEAPON_MARKSMANRIFLE") then
			...
			ESX.ShowNotification((
				"Du hast keine Waffe in der Hand oder deine Waffe kann nicht mit einem Griff ausgerüstet werden."))

		end
	else
		ESX.ShowNotification(("Du hast alle Griffe verbraucht."))
	end
end)
...
AddEventHandler('eden_accesories:yusuf', function(duration)
	...
	if used4 < yusuf then
		if currentWeaponHash == GetHashKey("WEAPON_PISTOL") then
			...
			ESX.ShowNotification((
				"Du hast deine Waffe mit dem einem Skin ausgerüstet. Er muss nach jedem Powernap neu ausgerütstet werden."))
			used4 = used4 + 1
		...
		elseif currentWeaponHash == GetHashKey("WEAPON_ADVANCEDRIFLE") then
			...
			ESX.ShowNotification(("Du hast keine Waffe in der Hand oder deine Waffe kann diesen Skin nicht verwenden."))
		end
	else
		ESX.ShowNotification(("Du hast alle Skins verbraucht."))
	end
end)
